...
$res_events = $newsObj->getNewsByURL($k_url); 
...
<?php
if($_GET['url'])	{		
$id = $res_events['oDATA'][0]['id'];
$publish_date = outText($res_events['oDATA'][0]['publish_date']);
$title = outText($res_events['oDATA'][0]['title']);
$description = $res_events['oDATA'][0]['description'];
$category = outText($res_events['oDATA'][0]['category']);
$file_name = outText($res_events['oDATA'][0]['file_name']);
?>
<div class="col-sm-12">
			<div class="tag-title">
					<h2>Article</h2>
